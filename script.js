...
async function viewArtworkDetails(artId, source) {
    try {
        ...
        // Show modal
        document.getElementById("artDetailsModal").style.display = "block";
...
function closeDetailsModal() {
    ...
    window.addEventListener("click", (event) => {
        ...
        // If modal is open and the click is outside the content box, close it
...
function disconnectWallet() {
  try {
    ...
    // Update UI
    document.getElementById("profileWallet").textContent = "Wallet: Not Connected";
    document.getElementById("profileName").textContent = "Guest User";

    showToast("Wallet disconnected successfully.", "success");

    // Optionally clear cached data or redirect
    document.getElementById("userArtworks").innerHTML = "";
    document.getElementById("userPurchases").innerHTML = "";

    // You could also redirect to gallery or home
    // showSection('gallery');
  } catch (error) {
