...
function openResellModal(artId, artTitle, currentPrice = 0, category = "", year = "") {
  selectedResellArtId = artId;

  document.getElementById("resellArtTitle").textContent = `“${artTitle}”`;
  document.getElementById("resellPrice").value = currentPrice || "";
  document.getElementById("resellCategory").value = category || "—";
  document.getElementById("resellYear").value = year || "—";
