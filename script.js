...
async function connectWallet() {
    ...
    try {
        ...
        if (!chainId !== '0xaa36a7' && chainId !== '11155111') {//!allowedChains.includes(chainId)) {
            ...
            try {
                ...
                if (switchError.code === 4902) {
                    ...
                    showToast('Please manually switch to Sepolia Testnet in MetaMask', 'error');
                    return;
                }
            }
        }
        ...
        if (accounts.length > 0) {
            ...
            updateWalletUI();
            showToast('Wallet connected successfully (Sepolia Testnet)!', 'success');
